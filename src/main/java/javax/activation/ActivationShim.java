...
public interface ActivationShim extends Shim {
    //==================================================================================================================
    // Helper Methods
    //==================================================================================================================
    ...
    static <S extends ActivationShim> S of(Object object) {
        if (object == null || object instanceof ActivationShim) {
            return S(object);
    ...
    static <S extends ActivationShim> Stream<S> of(Iterable<?> objects) {
        return Shim.of(ActivationShim::of, objects);
    }
    ...
    private static <S extends Annotation> S of(Annotation annotation) {
        if (annotation == null || annotation instanceof ActivationShim) {
            return S(annotation);
        }
