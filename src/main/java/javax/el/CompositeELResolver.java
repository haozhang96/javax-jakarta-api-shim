 ...
 * @apiNote This class cannot extend {@link jakarta.el.CompositeELResolver} due to class hierarchy divergence.
 */
@Deprecated(since = "jakarta.el.CompositeELResolver")
public class CompositeELResolver extends ELResolver {
    private final jakarta.el.CompositeELResolver target = new jakarta.el.CompositeELResolver();
    ...
    /**
     * @see jakarta.el.CompositeELResolver#add(jakarta.el.ELResolver)
     */
