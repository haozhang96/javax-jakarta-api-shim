 ...
 * @apiNote This class cannot extend {@link jakarta.el.StaticFieldELResolver} due to class hierarchy divergence.
 */
@Deprecated(since = "jakarta.el.StaticFieldELResolver")
public class StaticFieldELResolver extends ELResolver {
    private final jakarta.el.StaticFieldELResolver target = new jakarta.el.StaticFieldELResolver();
