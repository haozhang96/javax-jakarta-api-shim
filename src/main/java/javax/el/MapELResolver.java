...
/**
 * @deprecated Use {@link jakarta.el.MapELResolver} instead.
 * @apiNote This class cannot extend {@link jakarta.el.MapELResolver} due to class hierarchy divergence.
 */
@Deprecated(since = "jakarta.el.MapELResolver")
public class MapELResolver extends ELResolver {
    ...
    /**
     * @see jakarta.el.MapELResolver#MapELResolver()
     */
    public MapELResolver() {
        target = new jakarta.el.MapELResolver();
    }

    /**
     * @see jakarta.el.MapELResolver#MapELResolver(boolean)
     */
    public MapELResolver(boolean isReadOnly) {
        target = new jakarta.el.MapELResolver(isReadOnly);
    }
     ...
     */
    @Deprecated(since = "jakarta.el.MapELResolver")
    public static class Retrofit extends Retrofits.MapELResolver {
        //==============================================================================================================
        // Constructors
        //==============================================================================================================

        public Retrofit(MapELResolver target) {
            super(target);
        }
    }
}
